...
from src.utils.ops import get_activation_module, trunc_exp
from src.utils.typing import Dict, Literal, Optional
...
class RENIField(BaseModule):
    ...
    def get_outputs(
        ...
        outputs[Names.RADIANCE.add_suffix("env")] = model_outputs
    ...
    def forward(
        ...
        """
        rays_d = outputs[Names.DIRECTION.add_suffix("env")]
        latent_codes = outputs[Names.RENI_LATENT]
        rotation = outputs[Names.ILLUMINATION_ROTATION]
        scale = outputs[Names.ILLUMINATION_STRENGTH]
    ...
    def produced_keys(self):
        return super().produced_keys() | {Names.RADIANCE.add_suffix("env")}

    def consumed_keys(self):
        return super().consumed_keys() | {
            Names.DIRECTION.add_suffix("env"),
            Names.RENI_LATENT,
            Names.ILLUMINATION_ROTATION,
            Names.ILLUMINATION_STRENGTH,
        }
